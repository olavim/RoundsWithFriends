...
namespace RWF.GameModes
{
	public class GM_TeamDeathmatch : MonoBehaviour
	{
		...
		public static void RPC_SyncBattleStart(int requestingPlayer, int timeOfBattleStart) 
        {
            ...
            GM_TeamDeathmatch.instance.timeUntilBattleStart = timeOfBattleStart - PhotonNetwork.ServerTimestamp;
		...
		private IEnumerator SyncBattleStart() {
            ...
            if (PhotonNetwork.IsMasterClient)
            {
			    ...
			    yield return this.SyncMethod(nameof(GM_TeamDeathmatch.RPC_SyncBattleStart), null, PhotonNetwork.LocalPlayer.ActorNumber, timeOfBattleStart);
            }
